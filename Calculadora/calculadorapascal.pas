...
begin
 {$asmmode intel}
  ...
  begin
    ...
    for Index := 1 to OperationIndex do
    begin
      //      Exibicao na visualizacao para testes
      ...
      //  end;
      //  else
      //  //TempNumber := strtofloat(TempString);
      //end;
      if OperationList[Index] = '+' then
      begin
        {$asmmode intel}
        asm
                 FINIT
  ...
  DebugVisualization.Text := floattostr(Result);
end;
